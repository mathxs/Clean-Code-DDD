...
describe('Watched List', () => {
  ...
  test('should be able to add a new item to the list', () => {
    const list = new NumberWatchedList([1, 2, 3])
    list.add(4)
  ...
  test('should be able to remove item to the list', () => {
    const list = new NumberWatchedList([1, 2, 3])
    list.remove(2)
  ...
  test('should be able to add item even if it was removed before', () => {
    const list = new NumberWatchedList([1, 2, 3])
    list.remove(2)
    list.add(2)
